...
public class ListviewRemoteUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getJSON("http://192.168.43.123:8080/sqli/getData.php");
        final Intent intent = new Intent(this, RemoteUpdate.class);
