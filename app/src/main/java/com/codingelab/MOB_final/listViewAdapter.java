...
public class listViewAdapter {
    public ArrayList<RemoteUsers> personlist;
    Activity activity;

    public listViewAdapter(Activity activity, ArrayList<RemoteUsers> personlist) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RemoteUsers item = personlist.get(position);
