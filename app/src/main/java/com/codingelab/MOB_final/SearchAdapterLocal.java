...
public class SearchAdapterLocal extends BaseAdapter {
    private LayoutInflater layoutInflater;
    private List<Users> listItemStorage;

    public SearchAdapterLocal(Context context, List<Users> customizedListView) {
